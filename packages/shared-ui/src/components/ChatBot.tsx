...
interface ChatBotProps {
  ...
  supabase?: any; // Make supabase optional for shared component
  useToast?: () => { toast: (options: any) => void }; // Make toast optional
}
...
export const ChatBot = ({ agentType, supabase, useToast }: ChatBotProps) => {
      ...
      if (supabase) {
        ...
        setTimeout(() => {
          setMessages(prev => [...prev.slice(0, -1), { 
            role: 'assistant', 
            content: "I'm a demo chat bot. In a real implementation, I would connect to SISO's AI systems to provide helpful responses!"
          }]);
          setIsLoading(false);
        }, 3000);
        return;
